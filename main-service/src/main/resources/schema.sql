...
CREATE TABLE IF NOT EXISTS comments (
                                        ...
                                        patched timestamp NULL,
                                        text_com varchar NOT NULL,
                                        CONSTRAINT comments_pk PRIMARY KEY (id),
    CONSTRAINT comments_fk FOREIGN KEY (id_user) REFERENCES users (id),
    CONSTRAINT comments_fk2 FOREIGN KEY (id_event) REFERENCES events (id)
    );